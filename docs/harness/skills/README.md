...
| `step6-release/SKILL.md` | Step 6: 全流程发版（GitHub desktop+linux-cli / npm 全平台 cli / CI；见 `procedure.md`） |
...
| `step6-release/procedure.md` | 发版操作正本：形态×系统×架构、渠道矩阵、命名、共用构建与验收 | `./start.sh package`、`scripts/release/*`、`scripts/publish-centag-npm.sh`、`scripts/install.sh` |
