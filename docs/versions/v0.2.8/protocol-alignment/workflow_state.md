...
> 创建日期：2026-07-22 | 最后更新：2026-07-23
...
| **Phase 5** 发版 | Step 6: 发版 | ✅ | 2026-07-23 | GitHub Release `v0.2.8`（Path B 重建上传） |
...
| Gate 5 | 发版准出（Release 资产 + 冒烟） | ✅ | 2026-07-23 | personal×6 + checksums 已更新；安装验收：用户手动 |
...
- [x] **自测记录** → `docs/versions/v0.2.8/protocol-alignment/自测记录.md`
- [x] **CR 报告** → `docs/versions/v0.2.8/protocol-alignment/CR_报告.md`（结论含是否批准发版）
- [x] **代码 + 测试** → 对应 `core/` / `plugins/` / `web/`
- [x] **GitHub Release**（Step 6）→ `v0.2.8`
...
| 2026-07-23 | Step 6 重跑 Path B：重建 personal 六平台产物并 `--clobber` 上传至已有 Release | 远端 v0.2.8 已公开（非草稿）；脚本对已有 Release 仅覆盖资产 | AI |
