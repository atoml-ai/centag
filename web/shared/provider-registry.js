...
const PROVIDER_REGISTRY = {
  ...
  baichuan: {
    ...
    icon: '🌊',
    description: '百川智能 API（Baichuan 系列）',
    default_models: [
      { name: 'Baichuan4', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'Baichuan3-Turbo', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 32000 },
    ],
  },
  yi: {
    id: 'yi',
    ...
    env_key: 'YI_API_KEY',
    icon: '🔮',
    description: '零一万物 API（Yi 系列）',
    default_models: [
      { name: 'yi-large', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 32000 },
      { name: 'yi-medium', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 16384 },
    ],
  },
  stepfun: {
    id: 'stepfun',
    ...
    icon: '🚀',
    description: '阶跃星辰 API（Step 系列）',
    default_models: [
      { name: 'step-2-16k', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 16384 },
      { name: 'step-1-flash', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 8192 },
    ],
  },
  spark: {
    id: 'spark',
    ...
    icon: '✨',
    description: '讯飞星火 API（Spark 系列）',
    default_models: [
      { name: 'generalv3.5', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 8192 },
      { name: 'generalv3', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 8192 },
    ],
  },
  minimax_pro: {
    id: 'minimax_pro',
    ...
    type: 'openai',
    base_url: 'https://api.minimax.chat/v1',
    env_key: 'MINIMAX_PRO_API_KEY',
    icon: '💎',
    description: 'MiniMax Pro（稀宇科技高级版）',
    default_models: [
      { name: 'MiniMax-M2.5', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 1000000 },
    ],
  },
  zhipu_new: {
    ...
    type: 'openai',
    base_url: 'https://open.bigmodel.cn/api/paas/v4',
    env_key: 'ZHIPU_NEW_API_KEY',
    icon: '🟤',
    description: '智谱 AI 新版 API',
    default_models: [
      { name: 'glm-4-plus', supports_tools: true, supports_images: true, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  ...
  mistral: {
    ...
    icon: '🌀',
    description: 'Mistral AI API（Mistral 系列）',
    default_models: [
      { name: 'mistral-large-latest', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'mistral-small-latest', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 32000 },
      { name: 'codestral-latest', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 32000 },
    ],
  },
  cohere: {
    id: 'cohere',
    ...
    icon: '🔷',
    description: 'Cohere API（Command 系列）',
    default_models: [
      { name: 'command-r-plus', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'command-r', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  stability: {
    id: 'stability',
    ...
    icon: '🎨',
    description: 'Stability AI API（Stable 系列）',
    default_models: [
      { name: 'stable-image-v1', supports_tools: false, supports_images: true, supports_thinking: false, max_context_tokens: 8192 },
    ],
  },
  inflection: {
    id: 'inflection',
    ...
    env_key: 'INFLECTION_API_KEY',
    icon: '🧠',
    description: 'Inflection AI API（Pi 系列）',
    default_models: [
      { name: 'pi-2.0', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  ai21: {
    id: 'ai21',
    ...
    icon: '📚',
    description: 'AI21 Labs API（Jamba 系列）',
    default_models: [
      { name: 'jamba-1.5-large', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 256000 },
      { name: 'jamba-1.5-mini', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 256000 },
    ],
  },
  groq: {
    id: 'groq',
    ...
    icon: '⚡',
    description: 'Groq API（超高速推理）',
    default_models: [
      { name: 'llama-3.1-405b-versatile', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'llama-3.1-8b-instant', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  deepinfra: {
    id: 'deepinfra',
    ...
    icon: '🔮',
    description: 'DeepInfra API（开源模型推理）',
    default_models: [
      { name: 'meta-llama/Llama-3.1-405B-Instruct', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  together: {
    id: 'together',
    ...
    icon: '🤝',
    description: 'Together AI API（开源模型集群）',
    default_models: [
      { name: 'meta-llama/Llama-3.1-405B-Instruct-Turbo', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'mistralai/Mixtral-8x22B-Instruct-v0.1', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 65536 },
    ],
  },
  fireworks: {
    id: 'fireworks',
    ...
    icon: '🎆',
    description: 'Fireworks AI API（快速推理）',
    default_models: [
      { name: 'accounts/fireworks/models/llama-v3p1-405b-instruct', supports_tools: true, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  perplexity: {
    id: 'perplexity',
    ...
    icon: '🔍',
    description: 'Perplexity AI API（搜索增强）',
    default_models: [
      { name: 'llama-3.1-sonar-large-128k-online', supports_tools: false, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
      { name: 'llama-3.1-sonar-small-128k-online', supports_tools: false, supports_images: false, supports_thinking: false, max_context_tokens: 128000 },
    ],
  },
  zhipu: {
    id: 'zhipu',
